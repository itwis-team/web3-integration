...
export const PoolCard = (props) => {
    ...
    useEffect(() => {
        if (typeof farm.stakeToken.logo != "undefined") {
            setToken0Logo(farm.stakeToken.logo);
        }
        else {
            const tokenInfo0 = token_list.tokens.find(token => token.symbol === farm.stakeToken.symbol);
                    ...
                    <div className="card-body">
                        <div>
                            <h4 className="fw-bold card-top">
                                <img src={token0Logo == null ? unknown_img : token0Logo} className="single-image" />
                                <img src={rewardTokenLogo == null ? unknown_img : rewardTokenLogo} className="second-image" />
                                <br />{farm.stakeToken.symbol}</h4>
                        ...
                        {!isHide &&
                            <div className="row">
                                <div className="col-6 apr-section">
                                    <p className='apr-text'><strong className='red-title'>
                                        APR <span className="d-inline-block" tabIndex="0" data-toggle="tooltip" data-placement="top" title="Note : APRs are provided for your convenience. APRs are constantly changing and do not represent guaranteed returns.">
                                    ...
                                    </strong><br /><br /><strong>{farm.apr}%</strong><br /></p>
                                </div>
                                ...
                                <div className="col-6">
                                    <p className='deposit-text'><strong className='red-title'>My deposit</strong><br />${(myDepositToken * farm.stakeTokenPrice).toFixed(2)}<br />
                                        <sub>
                                            <strong className='red-title'>{farm.stakeToken.symbol}</strong>
                                        </sub><br /><sub><strong>{myDepositToken}</strong></sub><br /></p>
                                </div>
                                <div className="col-6">
                                ...
                                {farm.farmOwner.toLowerCase() != walletAddress &&
                                    <div className="col harvest-label">
