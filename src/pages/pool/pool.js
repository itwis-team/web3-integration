                ...
                <div className="container py-4 py-xl-5">
                    <div className="row gy-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
                        {isLoading ? <div className="col-12 col-xl-12 align-center">
                            ...
                            <span style={{ color: "white" }}>No Token Pool is found</span>
                        </div> : poolList.map( ( farm, index ) => (
                            displayMode == 0 ? ( farm.endsIn > 0 && <PoolCard farm={farm} key={index} /> ) : ( farm.endsIn <= 0 && <PoolCard farm={farm} key={index} /> ) ) ) )
                        }
