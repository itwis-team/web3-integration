...
export const CreateFarm = () => {
    ...
    const [mainToken0, setMainToken0] = useState({});
    const [mainToken1, setMainToken1] = useState({});
        ...
        switch (curStep) {
            case 1:
                return <Tab1 onNext={setCurStep} functions={
                    {
                        mainToken0: mainToken0,
                        mainToken1: mainToken1,
                        lpToken: lpToken,
                        ...
                        setMainToken0: setMainToken0,
                        setMainToken1: setMainToken1,
                            ...
                            <div className="card border-light border-1 d-flex justify-content-center p-4 main-card">
                                <div className="card-body bg-card-body">
                                    <div className="bg-card-cap">
                                        <h4 className="fw-bold card-text-center"><br />LP token farm creation</h4>
                                        <p style={{ textAlign: "center" }}><span style={{ color: "rgb(255, 255, 255)" }}>Stake tokens to receive farming rewards</span></p>
